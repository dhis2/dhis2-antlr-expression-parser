...
expr
    ...
    |   it='d2:count(' WS* STRING_LITERAL WS* ')'
    ...
    |   it='d2:hasValue(' WS* STRING_LITERAL WS* ')'
    ...
    |   it='d2:maxValue(' WS* STRING_LITERAL WS* ')'
    ...
    |   it='d2:minValue(' WS* STRING_LITERAL WS* ')'
